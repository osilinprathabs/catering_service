    ...
    <div class="container">
        ...
        <div class="row gx-4 justify-content-center">
            ...
            <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.1s">
                <div class="blog-item">
                    <div class="overflow-hidden rounded">
                        <img src="img/blog-1.jpg" class="img-fluid w-100" alt="Pongal Catering">
                    </div>
                    <div class="blog-content mx-4 d-flex rounded bg-light">
                        ...
                        <a href="#" class="h5 lh-base my-auto h-100 p-3">
                            Perfect **Pongal** for 500 Guests: Our Secret Recipe
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.3s">
                <div class="blog-item">
                    <div class="overflow-hidden rounded">
                        <img src="img/blog-2.jpg" class="img-fluid w-100" alt="Wedding Catering">
                    </div>
                    <div class="blog-content mx-4 d-flex rounded bg-light">
                        <div class="text-dark bg-primary rounded-start">
                            <div class="h-100 p-3 d-flex flex-column justify-content-center text-center">
                        ...
                        <a href="#" class="h5 lh-base my-auto h-100 p-3">
                            How We Served **1000 Idlis in 30 Minutes** at a Madurai Wedding
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.5s">
                <div class="blog-item">
                    <div class="overflow-hidden rounded">
                        <img src="img/blog-3.jpg" class="img-fluid w-100" alt="Filter Coffee">
                    </div>
                    <div class="blog-content mx-4 d-flex rounded bg-light">
                        <div class="text-dark bg-primary rounded-start">
                            <div class="h-100 p-3 d-flex flex-column justify-content-center text-center">
                                <p class="fw-bold mb-0">01</p>
                                <p class="fw-bold mb-0">Nov</p>
                            </div>
                        </div>
                        <a href="#" class="h5 lh-base my-auto h-100 p-3">
                            The Art of **Filter Coffee** – Why Guests Ask for 2nd Round
                        </a>
                    </div>
                </div>
            </div>
